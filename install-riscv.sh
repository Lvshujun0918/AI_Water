...
download_compose_file() {
    local url="https://gh.llkk.cc/https://raw.githubusercontent.com/Lvshujun0918/AI_Water/refs/heads/main/docker-compose.riscv.yml"
    ...
    if wget -q --show-progress "$url"; then
        ...
        mv "docker-compose.riscv.yml" "$filename"
        # 显示文件信息
        if [ -f "$filename" ]; then
