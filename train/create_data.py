...
if __name__ == '__main__':
    ...
    #                                       list_path='dataset/')
    # 创建UrbanSound8K数据列表
    create_UrbanSound8K_list(audio_path=r'D:\work_software\PyCharmWork\audioClassification\AudioClassification-Pytorch-master\dataset\audio',
                             # audio_path='dataset/UrbanSound8K/audio',
                             # metadata_path='dataset/UrbanSound8K/metadata/UrbanSound8K.csv',
                             metadata_path=r'D:\work_software\PyCharmWork\audioClassification\AudioClassification-Pytorch-master\dataset\audio-all\UrbanSound8K\metadata\UrbanSound8K.csv',
                             list_path='dataset')
